                  ...
                  >
                    ...
                    <el-form-item label="用户头像">
                      <el-upload
                        ...
                        :action="'http://120.79.80.66:9011/admin/admin/upload?id=' + id"
...
export default {
  ...
  methods: {
    // 查询个人数据
    async getProfile(id) {
      var result = await this.$proxy.AdminProfile({ id: id });

      if (result.code == 1) {
        this.ruleForm = result.data;
        // this.ruleForm.password = '';
        // this.ruleForm.repass= result.data.password
    ...
    async onEdit() {
      ...
      this.$refs.ruleForm.validate(async (valid) => {
        ...
        //     return false;
        // }
        var result = await this.$proxy.AdminEdit(this.ruleForm);
        this.$notify({
          title: "成功",
          message: result,
          type: "success",
